...
インストールしてあると、この記事に書いてあるようにトラブルかもしれない。
...
# カラーフィルタを作ってみる
## やること
カメラからキャプチャした映像の中で、特定の色以外をマスクする。

↓こんな画像を

![Photo](/images/raw_image.png)

↓こんな感じにする

![Photo](/images/filtered_image.png)
...
しかし、光の当たり方などこうりょした色の範囲を定義するのは難しい。
...
[github](https://github.com/tok41/ObjectTracker/tree/master/videoCapture)
にアップしているコードでは、getColorROIという関数に実装している。
